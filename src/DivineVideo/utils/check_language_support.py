...
support_languages = {
    ...
    "Turkish", "Turkmen", "Ukrainian", "Urdu", "Uzbek", "Valencian", "Vietnamese", "Welsh", "Yiddish", "Yoruba"
}

def check_language(input_language = None):
    if not input_language:
        raise exceptions.DivineVideoException("Input language is None!")

    if input_language not in support_languages:
        raise exceptions.DivineVideoException("Please input the valid language!")
